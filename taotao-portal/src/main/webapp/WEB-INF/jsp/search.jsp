...
<div  id="pagin-btm" class="pagin fr" clstag="search|keycount|search|pre-page2">
	...
	<a href="javascript:void(0)" class="searchByPage current">1</a>
	<a href="search.html?q=${query}&page=2" class="searchByPage hide">2</a>
	<a href="search.html?q=${query}&page=3" class="searchByPage hide>3</a>
	<a href="search.html?q=${query}&page=4" class="searchByPage hide>4</a>
	...
	<span class="page-skip"><em>&nbsp;&nbsp;共${totalPages}页&nbsp;&nbsp;&nbsp;&nbsp;到第</em>${page}</span>
</div>
</div>
